...
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Move down, center on screen' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Move up, Center on screen' })
vim.keymap.set('n', 'n', 'nzzzv', { desc = 'Search, center on screen' })
vim.keymap.set('n', 'N', 'Nzzzv', { desc = 'Search back, center on screen' })
...
-- maps the Esc key in terminal mode ('t') to exit terminal insert mode and return to normal mode within the terminal window.
vim.api.nvim_create_autocmd('TermOpen', {
  pattern = '*',
  callback = function()
    vim.keymap.set('t', '<Esc>', '<C-\\><C-n>', { noremap = true, silent = true, desc = 'Exit Terminal Insert Mode' })
    -- Add more terminal-specific keymaps here, e.g., for navigation
    -- vim.keymap.set('t', '<C-h>', '<C-\\><C-n><C-w>h', { noremap = true, silent = true, desc = 'Move to Left Split' })
  end,
})

vim.keymap.set('n', '<leader>s', vim.diagnostic.setloclist, { desc = '[S]ession persistence' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lw', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open [W]orkspace Symbols')
      ...
      vim.diagnostic.config {
        ...
        signs = vim.g.have_nerd_font
            and {
              ...
              values = {
                { name = 'DiagnosticSignError', text = '󰅚' }, -- Custom error sign
                { name = 'DiagnosticSignWarn', text = '󰀪' }, -- Custom warning sign
                { name = 'DiagnosticSignHint', text = '󰋽' }, -- Custom hint sign
                { name = 'DiagnosticSignInfo', text = '󰌶' }, -- Custom info sign
              },
            }
          or {},
        virtual_text = {
