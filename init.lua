...
{ -- Highlight, edit, and navigate code
  ...
  lazy = false,
  build = ':TSUpdate',
  -- Standard branch is 'master', 'main' is often used for experimental rewrites.
  -- Only use 'main' if you specifically need the new experimental features.
  branch = 'master', 
  config = function()
    require('nvim-treesitter.configs').setup({
      -- This replaces your manual vim.treesitter.install(parsers)
      ensure_installed = { 
        'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 
        'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' 
      },

      -- This replaces your entire Autocmd logic
      auto_install = true,
    ...
    -- Optional: If you still want tree-sitter based folding
